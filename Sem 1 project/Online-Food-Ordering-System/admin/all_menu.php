<!--  Author Name: Chirag Thanki
                        GigHub Link: https://github.com/chigs-thanky
                        Contact: +91-9638798285
                        Email: chiragthanki12@gmail.com-->
<!DOCTYPE html>
<html lang="en">
<?php
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/user_icon.jpg"
        ...
        <div class="page-wrapper">
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">Created By <a
                        href="https://chigs-thanky.github.io/Chirag-J-Thanki-Portfolio/">Chirag Thanki</a></marquee>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr><td>' . $fetch['title'] . '</td> <td>' . $rows['title'] . '</td>
			<td>' . $rows['slogan'] . '</td>
			<td>₹' . $rows['price'] . '</td>			<td><div class="col-md-3 col-lg-8 m-b-10">
